...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/boosted-odds", label: "ZillaBoost", Icon: I.Star, matchPrefix: "/admin/boosted-odds" },
    ],
  },
  {
    label: "Operations",
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: "/admin/slotzilla",
        label: "SlotZilla",
        Icon: I.Ticket,
        matchPrefix: "/admin/slotzilla",
      },
      {
