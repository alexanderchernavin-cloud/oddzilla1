...
import adminInsightWidgetsRoutes from "./modules/admin/insight-widgets.js";
import slotzillaRoutes from "./modules/slotzilla/routes.js";
import adminSlotzillaRoutes from "./modules/admin/slotzilla.js";
...
await app.register(adminInsightWidgetsRoutes);
await app.register(slotzillaRoutes);
await app.register(adminSlotzillaRoutes);
