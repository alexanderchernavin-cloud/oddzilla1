...
ORDER=(api ws-gateway web1 signer feed-ingester odds-publisher settlement bifrost-feed bet-delay wallet-watcher metrics-collector mail-receiver support-ai-bot caddy)
...
mark_all_built_services() {
  mark api ws-gateway web1 signer feed-ingester odds-publisher settlement bifrost-feed bet-delay wallet-watcher metrics-collector mail-receiver support-ai-bot
}
